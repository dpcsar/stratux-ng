...
func TestNDJSONClient_setState_ClearsStaleErrorOnConnected(t *testing.T) {
	c, err := NewNDJSONClient(NDJSONClientConfig{Name: "t", Addr: "127.0.0.1:1"})
	if err != nil {
		t.Fatalf("NewNDJSONClient: %v", err)
	}
